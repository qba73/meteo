...
func TestGetCoordinatesSinglePostCode(t *testing.T) {
	t.Parallel()

	ts := testhelper.NewTestServer(
...
func TestGetCoordinatesMultiplePostCodes(t *testing.T) {
	t.Parallel()
